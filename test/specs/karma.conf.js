...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      {pattern: 'app/assets/javascripts/pensions_calculator/**/*.js', included: false},
      {pattern: 'vendor/assets/components/**/*.js', included: false},
    ...
    exclude: [
      'vendor/assets/components/**/test/*.js'
    ],
